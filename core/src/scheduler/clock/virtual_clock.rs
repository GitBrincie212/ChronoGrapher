...
/// calls to advance methods ([`VirtualClock`] implements the [`AdvanceableSchedulerClock`] extension
...
/// the [`AdvanceableSchedulerClock`] extension trait and the [`Debug`] trait
///
/// # Example
/// ```ignore
