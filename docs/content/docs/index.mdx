...
Understanding is just the first step. Next, we’ll walk you through installing ChronoGrapher and setting up your first task,
while in parallel discussing the scheduling theory behind ChronoGrapher.