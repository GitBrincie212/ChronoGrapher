...
(more specifically given a current time, we want to find the future time). Additionally, Tasks contain a **Scheduling Policy**
to define how should they run exactly (not as important to understand)
