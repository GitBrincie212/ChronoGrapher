...
export function RenderProgrammingLanguageBased(props: {children: JSX.Element, target_name: string }) {
    const lang = useStore(currentlyUsedLangStore);
    return (props.target_name === lang && props.children)
}

export default function ProgrammingLangToggle() {
    const [currentIndexPL, setCurrentIndexPL] = React.useState<number | undefined>(undefined);
    ...
    useEffect(() => {
        ...
        currentlyUsedLangStore.setState(() => PROGRAMMING_LANGUAGES[currentIndexPL].name)
        localStorage.setItem("selected-programming-lang-idx", currentIndexPL.toString(10))
    }, [currentIndexPL]);
            ...
            >
                {currentIndexPL !== undefined && (
                    <div className="flex items-center gap-2">
                        ...
                        <div className="select-none font-semibold font-mono">{PROGRAMMING_LANGUAGES[currentIndexPL].name}</div>
                    </div>
                )}
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" fillRule="evenodd" d="M8 1a.5.5 0 0 1 .374.168l4 4.5l-.748.664L8 2.252l-3.626 4.08l-.748-.664l4-4.5A.5.5 0 0 1 8 1m0 12.747l-3.626-4.08l-.748.665l4 4.5a.5.5 0 0 0 .748 0l4-4.5l-.748-.664z" clipRule="evenodd"/></svg>
            </button>

            <div role="menu" className={
                `absolute top-12 z-auto w-56 overflow-hidden rounded-lg border border-fd-border bg-fd-background
                ...
                {PROGRAMMING_LANGUAGES.map((lang, idx) => (
                    <button
                        type="button"
                        className={
                        `w-full justify-between flex px-3 py-2 text-sm font-medium transition-colors 
                    ...
                    >
                        ...
                        {currentIndexPL === idx && (
                            <div className="flex justify-center items-center text-sm text-fd-foreground">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20"><path fill="currentColor" d="m0 11l2-2l5 5L18 3l2 2L7 18z"/></svg>
                            </div>
                        )}
                        {lang.disabled && (
                            <div className="flex justify-center items-center text-sm text-fd-foreground">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10m-4.906-3.68L18.32 7.094A8 8 0 0 1 7.094 18.32M5.68 16.906A8 8 0 0 1 16.906 5.68z"/></svg>
                            </div>
                        )}
                    </button>
                ))}
