...
- **[AI Use Case Guidelines](/docs/contributing/ai_use_guidelines)** Discusses the use of Generative AI in the contribution process,
  what is and isn't allowed, disclosing AI use case in PRs and what punishments may ensue if improper use is noticed.
...
- **[Tweaking The Website](/docs/contributing/guidebook_guidelines)** Briefly discusses how ChronoGrapher's website is structured, its various tools
    (tech stack) it as well as a basic overview of things.

<Callout type={"warning"} title={"Guidelines Are WIP"}>
    Currently the contribution guidelines are WIP (Work In Progress), this means they are not truly finalized and may
    change, for this reason it is best to:
    - Give feedback and how your experience went as a contributor (especially now).
    - Stay alert for any upcoming changes on the guidelines.
    - Ask McBrincie212 (the maintainer) for anything not covered currently by the guidelines.
</Callout>
...
3. Has a grasp of **Workflow Orchestration** and **Distributed Systems** concepts (persistence, fault tolerance... etc.).
...
read and follow the [Code of Conduct](https://github.com/GitBrincie212/ChronoGrapher/blob/master/CODE_OF_CONDUCT.md) to
